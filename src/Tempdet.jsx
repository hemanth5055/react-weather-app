...
function Tempdet({temp,temp_max,temp_min,feels}) {
    ...
    return (
        <div className='w-[480px]  h-full flex flex-col justify-center items-center max-sm:w-full max-sm:h-[150px]'>
            ...
            <h3 className='font-metro text-[1vw] text-slate-500 bottom-3 relative max-sm:text-[2.2vw] font-semibold max-sm:bottom-2.75'>{temp_max.toFixed(2)}/{temp_min.toFixed(2)} Feels like {feels.toFixed(2)} </h3>
        </div>
    )
}
